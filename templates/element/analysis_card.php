...
<!-- <div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="bg-primary-200 p-4 relative">
    <div class="w-20 h-20 mx-auto">
        <div class="w-full h-full bg-primary-500 rounded-md flex items-center justify-center">
        <div class="w-3/4 h-3/4 bg-white transform rotate-45"></div>
        </div>
    </div>
    <span class="absolute top-2 right-2 bg-primary-500 text-white text-xs font-semibold px-2 py-1 rounded-full">配信中</span>
    ...
    <div class="p-4">
    <h2 class="text-lg font-semibold mb-2">デフォルト顧客Value解析</h2>
    <p class="text-sm text-gray-600 mb-4">ここにこの解析ツールに関する説明がはいります。</p>
    </div>

    <div class="bg-gray-100 p-4 flex items-center justify-between">
    <div class="flex items-center">
        <span class="font-semibold mr-2">解析回数</span>
        <span class="bg-primary-500 text-white px-2 py-1 rounded">306</span>
    </div>
    ...
    <div class="flex border-t">
        <button class="flex-1 py-2 text-center border-r hover:bg-gray-100">編集</button>
        <button class="flex-1 py-2 text-center hover:bg-gray-100">削除</button>
    </div>
</div> -->
